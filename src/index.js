...
var express = require("express"); // note : not the best practice but I had an error with esModuleinterop 
var accounts_1 = require("./models/accounts");
var database_1 = require("./database/database");
var app = express();
// dummy data
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var account1, account2, account3, account4, account5, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                // Create five different account objects
                _a.sent();
                return [4 /*yield*/, accounts_1.default.create({
                        user_id: 'user001',
                        account_type: 'user',
            ...
            case 7:
                error_1 = _a.sent();
                console.error('Error creating accounts:', error_1);
                return [3 /*break*/, 8];
